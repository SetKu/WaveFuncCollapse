...
fn arrayify_works() {
    let input = vec![
        (0, Vector2::new(0, 0)), (1, Vector2::new(0, 1)), (2, Vector2::new(0, 2)), 
        (3, Vector2::new(1, 0)), (4, Vector2::new(1, 1)), (5, Vector2::new(1, 2)), 
        (6, Vector2::new(2, 0)), (7, Vector2::new(2, 1)), (8, Vector2::new(2, 2)), 
        (9, Vector2::new(3, 0)), (10, Vector2::new(3, 1)), (11, Vector2::new(3, 2)), 
    ];
